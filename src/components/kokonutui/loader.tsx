  ...
  <div
   ...
   <m.div
    ...
    <m.div
     ...
     style={{
      background: `conic-gradient(from 0deg, transparent 0deg, rgb(108, 41, 217) 90deg, transparent 180deg)`,
    ...
    <m.div
     className="absolute inset-0 rounded-full dark:hidden"
     style={{
      background: `conic-gradient(from 0deg, transparent 0deg, rgb(108, 41, 217) 120deg, rgba(108, 41, 217, 0.5) 240deg, transparent 360deg)`,
    ...
    <m.div
     className="absolute inset-0 rounded-full dark:hidden"
     style={{
      background: `conic-gradient(from 180deg, transparent 0deg, rgba(108, 41, 217, 0.6) 45deg, transparent 90deg)`,
    ...
    <m.div
     className="absolute inset-0 rounded-full dark:hidden"
     style={{
      background: `conic-gradient(from 270deg, transparent 0deg, rgba(108, 41, 217, 0.4) 20deg, transparent 40deg)`,
