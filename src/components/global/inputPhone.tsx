...
const PhoneInput: React.ForwardRefExoticComponent<PhoneInputProps> =
 React.forwardRef<React.ComponentRef<typeof RPNInput.default>, PhoneInputProps>(
  ({ className, onChange, value, Icon, iconColor, ...props }, ref) => {
   return (
...
const CountrySelect = ({
 ...
 return (
  <InputGroupAddon className="pl-[8px] h-full">
   <Popover open={isOpen} onOpenChange={setIsOpen} modal>
    <PopoverTrigger asChild>
     <Button
      ...
      variant="outline"
      size="sm"
      className="flex gap-1 rounded-none border-0 px-3 focus:z-10"
      disabled={disabled}>
...
const CountrySelectOption = ({
 ...
 return (
  <CommandItem className="gap-2" onSelect={handleSelect}>
   ...
   <Activity mode={country === selectedCountry ? "visible" : "hidden"}>
